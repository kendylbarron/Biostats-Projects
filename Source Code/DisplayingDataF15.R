...
MeaslesData <- read.csv("ABD_all_data/chapter02/chap02e4aMeaslesOutbreaks.csv")
MeaslesData
??lineplot

confirmedCases <-MeaslesData$confirmedCases
confirmedCases
year <- MeaslesData$yearByQuarter
year
plot (year, confirmedCases, type="l", xlim = c(1995,2015))
